...
__COMPOSED_REGEX = re.compile(
    fr'^{__CITY_REGEX_PART}' + __PARTS_SEPARATOR +
    fr'{__INSTITUTION_NAME_REGEX_PART}' + __PARTS_SEPARATOR +
    fr'{__INSTITUTION_NUMBER_REGEX_PART}' + __PARTS_SEPARATOR +
    fr'{__BOX_NUMBER_REGEX_PART}' + __PARTS_SEPARATOR +
